...
const (
	// RPCNameKey is convention for numeric status code of a gRPC request.
	SRPCStatusCodeKey = attribute.Key("rpc.srpc.status_code")
...
var (
	...
	RPCSystemGRPC = semconv.RPCSystemKey.String("srpc")
...
func StatusCodeAttr(c gcodes.Code) attribute.KeyValue {
	return SRPCStatusCodeKey.Int64(int64(c))
}
